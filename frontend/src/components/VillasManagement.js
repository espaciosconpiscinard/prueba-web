                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 bg-blue-50 p-4 rounded-md border-2 border-blue-200">
                    ...
                    {formData.has_pasadia && (
                      <div className="mb-4 p-3 bg-white rounded border-2 border-yellow-300">
                        <h4 className="font-semibold text-yellow-800 mb-3">☀️ Pasadía</h4>
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          <div>
                            ...
                            <Input 
                              type="text" 
                              value={formData.check_in_time_pasadia} 
                              onChange={(e) => setFormData({ ...formData, check_in_time_pasadia: e.target.value })} 
                              placeholder="9:00 AM" 
                              className="text-xs" 
                            />
                          </div>
                          <div>
                            ...
                            <Input 
                              type="text" 
                              value={formData.check_out_time_pasadia} 
                              onChange={(e) => setFormData({ ...formData, check_out_time_pasadia: e.target.value })} 
                              placeholder="8:00 PM" 
                              className="text-xs" 
                            />
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            ...
                            <Button type="button" size="sm" onClick={() => addPrice('pasadia')} className="h-6 px-2 text-xs bg-yellow-600">
                              + Agregar Precio
                            </Button>
                          </div>
                            ...
                            <div key={idx} className="bg-gray-50 p-3 rounded border">
                              <div className="flex justify-between items-center mb-2">
                                <Input 
                                  type="text" 
                                  value={price.label} 
                                  onChange={(e) => updatePrice('pasadia', idx, 'label', e.target.value)} 
                                ...
                                <Button 
                                  ...
                                  size="sm" 
                                  variant="destructive" 
                                  onClick={() => removePrice('pasadia', idx)} 
                                  className="h-6 px-2"
                                >
                                  <X size={12} />
                                </Button>
                              ...
                              <div className="grid grid-cols-2 gap-2 mb-2">
                                <div>
                                  ...
                                  <Input 
                                    ...
                                    onChange={(e) => updatePrice('pasadia', idx, 'client_price', e.target.value)} 
                                    placeholder="5000" 
                                    className="text-xs" 
                                  />
                                </div>
                                <div>
                                  ...
                                  <Input 
                                    ...
                                    onChange={(e) => updatePrice('pasadia', idx, 'owner_price', e.target.value)} 
                                    placeholder="4000" 
                                    className="text-xs" 
                                  />
                                </div>
                    ...
                    {/* EVENTO */}
                    {formData.has_evento && (
                      <div className="mb-4 p-3 bg-white rounded border-2 border-purple-300">
                        <h4 className="font-semibold text-purple-800 mb-3">🎉 Evento</h4>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <Label className="text-xs font-semibold">💰 Precios por Cantidad de Personas</Label>
                            <Button type="button" size="sm" onClick={() => addPrice('evento')} className="h-6 px-2 text-xs bg-purple-600">
                              + Agregar Precio
                            </Button>
                          </div>
                            ...
                            <div key={idx} className="bg-gray-50 p-3 rounded border">
                              <div className="flex justify-between items-center mb-2">
                                <Input 
                                  type="text" 
                                  value={price.label} 
                                  onChange={(e) => updatePrice('evento', idx, 'label', e.target.value)} 
                                  placeholder="Ej: 1-10 personas, 11-20 personas" 
                                  className="text-xs flex-1 mr-2" 
                                />
                                <Button 
                                  ...
                                  size="sm" 
                                  variant="destructive" 
                                  onClick={() => removePrice('evento', idx)} 
                                  className="h-6 px-2"
                                >
                                  <X size={12} />
                                </Button>
                              ...
                              <div className="grid grid-cols-2 gap-2 mb-2">
                                <div>
                                  ...
                                  <Input 
                                    ...
                                    step="0.01" 
                                    value={price.client_price} 
                                    onChange={(e) => updatePrice('evento', idx, 'client_price', e.target.value)} 
                                    placeholder="5000" 
                                    className="text-xs" 
                                  />
                                </div>
                                <div>
                                  ...
                                  <Input 
                                    ...
                                    step="0.01" 
                                    value={price.owner_price} 
                                    onChange={(e) => updatePrice('evento', idx, 'owner_price', e.target.value)} 
                                    placeholder="4000" 
                                    className="text-xs" 
                                  />
                                </div>
